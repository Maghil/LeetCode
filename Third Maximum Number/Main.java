...
class Solution {
    ...
    public static int thirdMax(int[] nums) {
        float first_max = Float.NEGATIVE_INFINITY;
        float second_max = Float.NEGATIVE_INFINITY;
        float third_max = Float.NEGATIVE_INFINITY;
        for (int i : nums) {
            if (i > first_max) {
        ...
        return (int) (third_max > Float.NEGATIVE_INFINITY ? third_max : first_max);
    }
}
